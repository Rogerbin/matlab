...
if wordflag
    ...
    if exist(savefilename,'file')
     ...
     word.ActiveWindow.WindowState= 'wdWindowStateMinimize';% 最小化
    %  'wdWindowStateMaximize'最大化，wdWindowStateNormal，正常
